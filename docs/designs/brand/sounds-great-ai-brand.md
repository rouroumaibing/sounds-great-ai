# Sounds Great AI Brand & Design Guidelines
...
### 角色色彩 (Role Tokens)
在深色背景下，必须使用亮度足够的主题色：
- **Opus Blue (灵缇)**: `#60A5FA` (Tailwind Blue 400)
- **Codex Green (边牧)**: `#34D399` (Tailwind Emerald 400)
- **Gemini Amber (金毛)**: `#FBBF24` (Tailwind Amber 400)
...
为了保护对晕动敏感的用户，必须始终提供静态降级版本。所有动效定义必须包裹在 `@media (prefers-reduced-motion: no-preference)` 下。
