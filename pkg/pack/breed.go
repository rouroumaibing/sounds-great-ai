...
// Leader is the human owner of the pack (the @leader handle).
// JSON tags use camelCase to match the frontend contract and the settings
...
func DefaultLeaderConfig() Leader {
	return Leader{
		Name:            "You",
