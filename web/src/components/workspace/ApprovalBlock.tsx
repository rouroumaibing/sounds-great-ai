  ...
  return (
    <div className="my-2 p-3 rounded-xl border border-amber-500/40 bg-amber-500/5 space-y-2">
      <div className="flex items-center gap-2 text-xs">
        ...
        <span className="font-bold text-amber-300">{t('workspace.approval.title')}</span>
      ...
      <input
        ...
        placeholder={t('workspace.approval.reasonPlaceholder')}
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <i className="fa-solid fa-check text-[9px] mr-1"></i>{t('workspace.approval.approve')}
        </button>
        <button
          onClick={handleReject}
          className="px-3 py-1 rounded-lg bg-rose-600 hover:bg-rose-500 text-white text-[11px] font-medium transition"
        >
          <i className="fa-solid fa-xmark text-[9px] mr-1"></i>{t('workspace.approval.reject')}
        </button>
      </div>
    </div>
  );
