...
|---|---|---|---|---|
| Orchestrator | 边牧 *(bianmu)* | 极高智商、控场大师、眼神敏锐 | 任务拆解、动态路由、结果合成 | 基于 Eino Graph，作为主控 Task Coordinator |
...
| Code Hunter | 灵缇 *(xigou)* | 身形流线、极速迅猛、目标明确 | 精准打猎：自动化 Refactor 方案设计、高难度 Bug 修复代码生成 | 专注于高难度代码优化、安全漏洞自动化"猎捕"修复 |
